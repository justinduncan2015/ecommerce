...
if($_POST['checkout']) //Post received from the cart.
{
	//Other important variables like tax, shipping cost
	$TotalTaxAmount 	= round($_SESSION['tax'],2);  //Sum of tax for all items in this order. 
	$ShippinCost 		= round($_SESSION['shipping'],2); //Sum of shipping for all items in this order. 
    ...
    foreach($_POST['item_name'] as $key=>$itmname)
    {
		...
		$results = $mysqli->query("SELECT product_name, price FROM products WHERE sku='$product_code' LIMIT 1");
	...
	$GrandTotal = ($ItemTotalPrice + $TotalTaxAmount + $ShippinCost);
	...
	$padata = 	'&METHOD=SetExpressCheckout'.
				...
				'&LOGOIMG=http://sulley.cah.ucf.edu/~da814350/DIG4530c/text-02.jpg'. //site logo
...
if(isset($_GET["token"]) && isset($_GET["PayerID"]))
{
	...
	{
            include("header.php");
            echo '<div class="process_container">';
            ...
            unset($_SESSION["cart_products"]);
				...
				*/
				...
				if('Completed' == $httpParsedResponseAr["PAYMENTINFO_0_PAYMENTSTATUS"])
				{
                    ...
                    echo '<p class="click">Click <a href="home.php">here</a> to return home.</p>';
                    echo '</div>';
				}
