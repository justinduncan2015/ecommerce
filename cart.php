  ...
  <tbody>
    ...
    if(isset($_SESSION["cart_products"])){
        ...
        foreach ($_SESSION["cart_products"] as $cart_itm)
        {
            ...
            echo '<td class="total"> <a href="#" class="mr10"> <i class="tooltip-test font24 icon-refresh " data-original-title="Update"> </i> </a><a href="#"><i class="tooltip-test font24 icon-remove-circle" data-original-title="Remove"> </i></a></td>';
       ...
       <div class="cart_edit large-6 medium-6 small-6 columns">
             ...
             <?php echo '<input type="hidden" name="return_url" value="'.$current_url = urlencode($url="http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']); $current_url;'"/>'; ?>
