        ...
        <div class="container">  
            ...
            <ul class="aboutus row">
               <li class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                <div>
                    <h2 class="heading2 icons"><i class="icon-group font72"></i>Who We Are </h2>
                ...
                <div>
                    <h2 class="heading2 icons"><i class="icon-time font72"></i>Our History</h2>
                ...
                <div>
                    <h2 class="heading2 icons"><i class="icon-upload font72"></i>Our Goal</h2>
                ...
                <div>
                    <h2 class="heading2 icons"><i class="icon-thumbs-up font72"></i>Satisfaction </h2>
                ...
                <div>
                    <h2 class="heading2 icons"><i class="icon-globe font72"></i>Worldwide Network</h2>
                ...
                <div>
                    <h2 class="heading2 icons"><i class="icon-signal font72"></i>Our Growth</h2>
